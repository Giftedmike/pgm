  ...
  return (
    <>  
        ...
        <div className="justify-content-center row text-center ps-3">
            ...
            <img src="sss.jpg" className="card-img-top" alt="Church beautification" />
            ...
            <div className="col services pb-3">
            <div className="card" style={{width: '18rem'}}>
            <img src="ssss.png" className="card-img-top" alt="Web Design" />
            <div className="card-body bg-warning">
            ...
            <div className="col services pb-3">
            <div className="card" style={{width: '18rem'}}>
            <img src="ss.jpg" className="card-img-top" alt="Architectural design" />
            <div className="card-body bg-info">
